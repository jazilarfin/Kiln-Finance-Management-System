...
def vehicle():
    ...
    vehicles_paginated = Vehicle.query.order_by(Vehicle.id.desc()).paginate(page=page, per_page=per_page)
...
def salesman():
    ...
    salesmen_paginated = Salesman.query.order_by(Salesman.id.desc()).paginate(page=page, per_page=per_page)
...
def brand():
    ...
    brands_paginated = Brand.query.order_by(Brand.id.desc()).paginate(page=page, per_page=per_page)
